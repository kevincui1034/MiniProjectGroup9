...
echo "Extracting wins per hero, sorting, and plotting them..."
INFILE=$(< dota2Test.csv)
OUTPUT_FILE="hero_wins.txt"
...
gnuplot plotwins.gp
echo "Wins have been outputted in hero_wins.txt and plotted in heroes_win_plot.png successfully."
